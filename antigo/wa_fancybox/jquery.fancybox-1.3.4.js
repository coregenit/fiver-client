...
function oealY(a,b)
{
var OoPbc=waJSQuery(a).attr("rel")
var CXpMN=waJSQuery(b).attr("rel") 
var heEOc=parseInt(extractParamInfo(waJSQuery(a),"index"))
var hrrqp=parseInt(extractParamInfo(waJSQuery(b),"index")) 
if(heEOc==hrrqp) return 0
if(heEOc<hrrqp) return-1
return 1
}
function QxvBJ(FFPOm)
{
var qPwxi=FFPOm.css("z-index")
var faigv=parseInt(qPwxi)
if(isNaN(faigv)==false)
{
FFPOm.css("z-index",1001101) 
}
else
{
FFPOm.css("z-index",10000000)
}
}
;(function(waJSQuery){
...
duration:currentOpts.speedOut,easing:currentOpts.easingOut,step:_draw,complete:eqNNJ
});
}else{
wrap.fadeOut(currentOpts.transitionOut=='none'?0:currentOpts.speedOut,eqNNJ);
}
};
